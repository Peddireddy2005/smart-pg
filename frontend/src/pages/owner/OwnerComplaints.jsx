...
import { Zap, Droplets, Wifi, Sparkles, Utensils, Pin, CheckCircle2 } from "lucide-react";
                  ...
                  <div className="flex gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <p className="font-semibold text-slate-800 flex items-center gap-2"><Icon size={15} className="text-slate-400" /> {c.title}</p>
                      ...
                      {c.assignedStaff && (
                        <p className="text-xs text-blue-600 mt-1">Assigned to {c.assignedStaff.name} ({c.assignedStaff.role})</p>
                      )}
                    </div>
                  </div>
