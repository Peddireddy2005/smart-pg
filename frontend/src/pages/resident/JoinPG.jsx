  ...
  if (!checkingProfile && assignedPG) {
    return (
      <div className="max-w-lg">
        <h1 className="font-heading text-2xl font-bold text-slate-900 mb-6">Join a PG</h1>
        <div className="card p-6 text-center">
          <Home size={32} className="mx-auto text-brand-500 mb-3" strokeWidth={1.5} />
          <p className="text-slate-700 font-medium">You're already assigned to a PG.</p>
  ...
  return (
    <div className="max-w-lg">
      ...
      {!checkingProfile && !hasPersonalDetails && (
        <div className="card p-4 mb-5 bg-amber-50 border-amber-200 flex gap-3">
          <TriangleAlert size={18} className="text-amber-500 shrink-0 mt-0.5" />
          <div>
            <p className="text-amber-800 text-sm font-medium">Complete your personal details first</p>
      ...
      {!checkingProfile && hasPersonalDetails && !hasIdProof && (
        <div className="card p-4 mb-5 bg-amber-50 border-amber-200 flex gap-3">
          <TriangleAlert size={18} className="text-amber-500 shrink-0 mt-0.5" />
          <div>
            <p className="text-amber-800 text-sm font-medium">Complete your ID verification first</p>
            <p className="text-amber-700 text-sm mt-1">
